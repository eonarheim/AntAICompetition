...
AgentEngine.prototype.logon = function (gameId) {
    ...
    var agent = this;
    this.client.post(url.resolve(this.endpoint, "api/game/logon"), args, function (data, response) {
...
AgentEngine.prototype.mainloop = function () {
    ...
    this.client.post(url.resolve(this.endpoint, "api/game/" + this.gameId + "/status/" + this.authToken), {}, function(data, response) {
    ...
    gotGameState.then(function(gameState) {
        ...
        agent.client.post(url.resolve(agent.endpoint, "api/game/update"), args, function (data, response) {
